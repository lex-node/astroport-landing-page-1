...
vec4 radialRainbow(vec2 st, float tick) {
  ...
  // colors
  vec4 a = vec4(0.137254902,0.1725490196,0.2705882353,1.0);
  vec4 b = vec4(0.1058823529,0.1333333333,0.2117647059,1.0);
  vec4 c = vec4(0.137254902,0.1725490196,0.2705882353,1.0);
  vec4 d = vec4(0.1058823529,0.1333333333,0.2117647059,1.0);
  vec4 e = vec4(0.1058823529,0.1333333333,0.2117647059,1.0);
