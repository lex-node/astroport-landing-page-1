...
vec3 gradient1(vec2 st, float tick) {
  vec3 c1 = vec3(0.137254902,0.1725490196,0.2705882353);
  vec3 c2 = vec3(0.1058823529,0.1333333333,0.2117647059);
  vec3 c3 = vec3(0.1058823529,0.1333333333,0.2117647059);
  vec3 c4 = vec3(0.0823529412,0.1019607843,0.1607843137);
